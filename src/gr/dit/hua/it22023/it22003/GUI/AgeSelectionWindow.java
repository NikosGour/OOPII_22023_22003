...
public class AgeSelectionWindow extends JFrame
{
    ...
    public AgeSelectionWindow(String title ,
                              MainGUI main) throws HeadlessException
    {
        super(title);
        this.main = main;
        $$$setupUI$$$();
    ...
    private void initComponents()
    {
        ...
        // ageSpinner
        //
        ((JSpinner.DefaultEditor) ageSpinner.getEditor()).getTextField()
                                                         .setEditable(false);
        ((JSpinner.DefaultEditor) ageSpinner.getEditor()).getTextField()
    ...
    private void GUIRecommend(Perceptron perceptron)
    {
        ...
        perceptron.recommend().forEach(x -> cities.set(cities.get() +
                                                       x +
                                                       "\n"));
    ...
    private void $$$setupUI$$$()
    {
        ...
        Main_Panel.add(confirmButton ,
                       new GridConstraints(1 ,
                                           ...
                                           false));
        ageLabel = new JLabel();
        Font ageLabelFont = this.$$$getFont$$$(null ,
                                               - 1 ,
                                               14 ,
                                               ageLabel.getFont());
